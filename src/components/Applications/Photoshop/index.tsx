			...
			<main className="photoshop__container">
				<aside className="photoshop__aside">
					<div className="photoshop__toolbox">
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Cursor.svg"
								alt="Cursor tool"
						...
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Move.svg"
								alt="Move tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/magnifier.svg"
								alt="magnifier tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Vector.svg"
								alt="Vector tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Text.svg"
								alt="Text tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Brush.svg"
								alt="Brush tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/pipette.svg"
								alt="pipette tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Stamp.svg"
								alt="Stamp tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Rubber.svg"
								alt="Rubber tool"
								className="photoshop__tool-img"
							/>
						</button>
						<button className="photoshop__tool">
							<img
								src="/images/apps/photoshop/icons/Blur.svg"
								alt="Blur tool"
								className="photoshop__tool-img"
							/>
						</button>
				...
				<section className="photoshop__content">
					<img
						...
						src="/images/apps/photoshop/graphic-design-meme.jpg"
